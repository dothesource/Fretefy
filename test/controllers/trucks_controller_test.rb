...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { account_id: @truck.account_id, name: @truck.name, truck_type: @truck.truck_type } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { account_id: @truck.account_id, name: @truck.name, truck_type: @truck.truck_type } }
